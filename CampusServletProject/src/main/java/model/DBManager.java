...
public class DBManager {
    ...
    public static List<StudentBean> getStudentsByBatch(int batchId) throws Exception {
    ...
    public static StudentBean getStudentById(int id) throws Exception {
    ...
    public static int updateStudent(StudentBean bean) throws Exception {
        String sql = "UPDATE student SET name = '" + bean.getName() +
                "', roll_num = '" + bean.getRollNum() +
                "', email = '" + bean.getEmail() +
                "', phone = '" + bean.getPhone() +
                "', gender = '" + bean.getGender() +
                "', dob = '" + bean.getDateOfBirth() +
                "', address = '" + bean.getAddress() +
                "', admission_date = '" + bean.getAdmission() +
                "', remarks = '" + bean.getRemarks() +
                "', batch_id = '" + bean.getBatchId() +
                "' WHERE id = " + bean.getId();
